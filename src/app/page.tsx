...
export default function Home() {
  ...
  const howToSteps = [
    { icon: <CalendarSearch className="h-8 w-8" />, title: "Elige fecha y lugar", description: "Selecciona cuándo y dónde recoges el auto." },
    { icon: <Car className="h-8 w-8" />, title: "Escoge tu auto", description: "Elige entre nuestra flota de vehículos." },
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main>
        <section className="hero-tropical text-white">
          <div className="container mx-auto px-4 py-24 md:py-32 text-center">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-8">
              Vive la isla con la libertad que mereces. Reserva fácil y rápido.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Button asChild variant="outline" size="lg" className="border-white/40 text-white hover:bg-white/10 rounded-full px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
               {howToSteps.map((step, index) => (
                   <div key={index} className="relative text-center group">
                       <div className="mx-auto bg-gradient-to-br from-primary to-[hsl(185,55%,40%)] text-white rounded-2xl h-20 w-20 flex items-center justify-center mb-4 shadow-md group-hover:shadow-xl group-hover:scale-105 transition-all duration-300">
        ...
        <section className="py-20 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-10">
              ...
              <Button asChild variant="outline" className="hidden sm:flex border-primary/30 text-primary hover:bg-primary hover:text-white rounded-full">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={i} className="text-center border border-primary/10 shadow-md hover:shadow-xl transition-all duration-300 rounded-2xl">
                  <CardHeader>
                    <div className="mx-auto bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl h-20 w-20 flex items-center justify-center mb-2">
        ...
        <section className="py-20 bg-secondary/50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <Card className="shadow-md border border-primary/10 rounded-2xl">
                <CardHeader>
                ...
                <CardContent>
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex gap-2"><span className="text-accent mt-1">★</span>Edad: 21-80 años.</li>
                    <li className="flex gap-2"><span className="text-accent mt-1">★</span>Licencia vigente (mín. 2 años).</li>
                    ...
                    <li className="flex gap-2"><span className="text-accent mt-1">★</span>Cargo extra por devolución diferente.</li>
        ...
        <section className="hero-tropical py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-headline text-3xl font-bold text-white mb-4">Tu aventura comienza aquí</h2>
            <p className="text-white/80 mb-8 max-w-lg mx-auto">Reserva hoy y recorre Cuba a tu ritmo</p>
            <Button asChild size="lg" className="bg-white text-primary hover:bg-white/90 font-bold rounded-full px-10 shadow-lg">
              <Link href="/autos">Ver Autos <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
          </div>
        </section>
