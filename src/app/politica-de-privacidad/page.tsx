        ...
        <Card className="max-w-4xl mx-auto shadow-lg">
            ...
            <CardContent className="space-y-6 text-muted-foreground prose prose-sm max-w-none">
                ...
                <div className="space-y-2">
                    <h3 className="font-headline text-xl text-primary">Cuba Car Rental optiene sus datos personales de las siguientes maneras:</h3>
                ...
                <div className="space-y-2">
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li>En caso que gane algun premio esponzorizado y organizado por Cuba Car Rental</li>
                ...
                <p>
                    Toda su información personal quedará registrada en la base datos de Cuba Car Rental. Usamos su información solo para un analisis de mercado y un crecimiento de la compañía y no proporcionamos informaciones de nuestros clientes a terceros.
                </p>
